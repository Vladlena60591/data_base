...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Июн 10 2023 г., 10:55
...
(1, 'Luker 65% TUMACO 1906', 4, 24, 1030, 123, '123', '213', '123', 0, 0, 1),
(2, 'Callebaut 823 33,6%', 2, 18, 875, 123, '123', '213', '123', 1, 0, 1),
(3, 'Cargill 54%', 3, 18, 590, 3, '3', '3', '3', 0, 0, 1),
(4, 'SICAO 28% каллеты', 1, 12, 655, 3, '3', '3', '3', 0, 0, 1),
(5, 'Barry Callebaut дезодорированное', 5, 36, 1050, 3, '3', '3', '3', 0, 0, 1),
(6, 'Carma Dark Bourbon 50%', 3, 3, 710, 3, '3', '3', '3', 0, 0, 1),
(7, 'Zephyr 34%', 1, 18, 1480, 20, 'Cacao Barry', '', '34% какао, 25.8% молоко, 40.4% жиры. Очень мягкий и едва подслащенный белый шоколад с гладкой текстурой и насыщенным вкусом цельного молока', 1, 1, 1),
(8, 'Бельгийский белый шоколад Sicao', 1, 12, 722, 500, 'Sicao', '', 'Каллеты\r\nОбласть применения: формование и глазирование', 0, 1, 1),
(9, 'Молочный шоколад Callebaut с карамелью', 2, 12, 1437, 40, 'Callebaut', '', 'Caramel Callets™. Молочный шоколад с настоящей карамелью', 1, 1, 1),
(10, 'Молочный шоколад Milk Seriz 35%', 2, 18, 964, 10, 'Carma', '', '35% какао, 19% молоко, 39,2% жиры. Отличается более кремовой текстурой, благодаря более высокому содержанию молока и чуть менее сладкому вкусу с нежными нотками какао.', 1, 0, 1),
(11, 'Тёмный шоколад Recipe N°811, 54.5%.', 3, 24, 914, 25, 'Callebaut', '', 'Содержание какао 54,5%. Насыщенный вкус какао и тонкие фруктовые ноты. ', 0, 1, 1),
(12, 'Горький шоколад Recipe N°70-30-42, 70.3%', 4, 24, 1022, 100, 'Callebaut', '', 'Очень горький шоколад, с высоким содержанием какао 70.3%', 0, 1, 1),
(13, 'Горький шоколад Ocoa 70%', 4, 24, 1462, 10, 'Cacao Barry', '', '70% какао, 38,7% жиры. Особый шоколадный кувертюр с хорошим вкусом какао и легкой кислинкой', 0, 1, 1),
(14, 'Какао масло Mycryo', 5, 12, 2471, 5, 'Callebaut', '', '100% натуральное какао-масло в виде микропорошка', 1, 1, 1);
