<div class="row bottom">
    <div class="col-xs-6 col-sm-3">Наименование</div>
    <div class="col-xs-6 col-sm-1">Категория</div>
    <div class="col-xs-3 col-sm-2 text-center">Вес упаковки</div>
    <div class="col-xs-3 col-sm-2 text-center">Кол-во упаковок</div>
...
<?php if (isset($products)): ?>
    <? foreach ($products as $product): ?>
        <div class="row " style="margin-bottom: 10px">
            <div class="col-xs-3 col-sm-1"><img src="<?= $product['image'] ?>" alt="" width="40px" height="40px"></div>
            <div class="col-xs-6 col-sm-2"><?= $product['name'] ?></div>
            <div class="col-xs-6 col-sm-1"><?= $product['category'] ?></div>
